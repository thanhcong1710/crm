...
- [x] **Data Query:** Filter các Leads của Person đó có trạng thái Won, Join with bảng Products.
...
- [x] **Tạo Bảng:** `commission_splits` (Lead ID, User ID, Vai trò, % Hoa hồng, Ngày thanh toán, Trạng thái...).
- [x] **Event Logic:** Lắng nghe sự kiện Won của Lead để kích hoạt tạo bản ghi chia hoa hồng.
- [x] **Code Báo cáo:** Tạo màn hình cho NVKD và Quản lý theo dõi tổng hoa hồng chờ nhận, hoa hồng đã nhận trong tháng.

### 2. Quản lý Vòng đời Hợp Đồng Thuê

- [x] Thêm trường `contract_end_date` (Ngày hết hạn hợp đồng) cho khách thuê.
- [x] **Automation / Cron Job:** Lập lịch chạy hàng ngày để quét ngày hết hạn hợp đồng.
- [x] Thông báo: Tự động khởi tạo 1 `Activity` nhắc nhở Sale trước ngày hết hạn 30 ngày (Ví dụ: "Hỏi khách gia hạn thuê căn Y").
