<header
    ...
    <div class="flex items-center gap-1.5">
        ...
        <a href="{{ route('admin.dashboard.index') }}" class="flex items-center gap-2">
            <div
                class="w-8 h-8 bg-brandColor rounded-lg flex items-center justify-center text-white font-bold text-lg shadow-sm">
                {{ config('app.admin_logo_icon_text', 'K') }}
            </div>
            <span class="text-xl font-bold text-gray-800 dark:text-white tracking-tight max-sm:hidden">
